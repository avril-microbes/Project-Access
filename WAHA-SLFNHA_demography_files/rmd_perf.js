...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 331 }, { marker: 'pandoc', elapsed: 83 }, { marker: 'post-processor', elapsed: 1 }, { marker: 'pre-processor', elapsed: 3 }, { marker: 'render', elapsed: 674 } ];
